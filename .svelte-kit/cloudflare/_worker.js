...
// .svelte-kit/output/server/chunks/index-0d7e3173.js
function noop() {
}
function run(fn) {
  return fn();
...
var getStores, page, css, Nav, _layout;
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    entry = "pages/__layout.svelte-d514184f.js";
    js = ["pages/__layout.svelte-d514184f.js", "chunks/vendor-069a40fc.js"];
    css2 = ["assets/pages/__layout.svelte-4ac88cd3.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    entry2 = "error.svelte-fe14ec02.js";
    js2 = ["error.svelte-fe14ec02.js", "chunks/vendor-069a40fc.js"];
    css3 = [];
  }
});

// .svelte-kit/output/server/chunks/MovieCard-71d66bc2.js
var css4, MovieCard;
var init_MovieCard_71d66bc2 = __esm({
  ".svelte-kit/output/server/chunks/MovieCard-71d66bc2.js"() {
    init_index_0d7e3173();
    css4 = {
...
async function load2({ fetch: fetch2 }) {
  const res = await fetch2(`${"https://api.themoviedb.org/3"}/movie/popular?api_key=${"22a2b619b5fe2221f6c9e2a24e7a28dd"}&language=en-US&page=1`);
  const data = await res.json();
  if (res.ok) {
    return { props: { popular: data.results } };
  }
}
var css$1, SearchMovies, css5, PopularMovies, Routes;
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
    init_index_0d7e3173();
    init_MovieCard_71d66bc2();
    css$1 = {
    ...
    SearchMovies = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let text = "";
    ...
    PopularMovies = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { popular } = $$props;
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_index_svelte();
    entry3 = "pages/index.svelte-8dfa9141.js";
    js3 = ["pages/index.svelte-8dfa9141.js", "chunks/vendor-069a40fc.js", "chunks/MovieCard-e2fec08d.js", "chunks/singletons-a6a7384f.js"];
    css6 = ["assets/pages/index.svelte-dda1a7b1.css", "assets/MovieCard-a2a2d614.css"];
  }
});

// .svelte-kit/output/server/entries/pages/search/_id_.svelte.js
...
async function load3({ fetch: fetch2, params }) {
  ...
  const res = await fetch2(`${"https://api.themoviedb.org/3"}/search/movie?api_key=${"22a2b619b5fe2221f6c9e2a24e7a28dd"}&language=en-US&page=1&include_adult=false&query=${searchMovieText}`);
  const data = await res.json();
  if (res.ok) {
    return {
      props: {
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_id_svelte();
    entry4 = "pages/search/_id_.svelte-9072128f.js";
    js4 = ["pages/search/_id_.svelte-9072128f.js", "chunks/vendor-069a40fc.js", "chunks/MovieCard-e2fec08d.js"];
    css8 = ["assets/pages/search/_id_.svelte-562cd39d.css", "assets/MovieCard-a2a2d614.css"];
  }
});

// .svelte-kit/output/server/entries/pages/movie/index.svelte.js
...
var init_index_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/movie/index.svelte.js"() {
    init_index_0d7e3173();
    Movie = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1>movie</h1>
<h2>root</h2>`;
    });
  }
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    init_index_svelte2();
    entry5 = "pages/movie/index.svelte-3066faf8.js";
    js5 = ["pages/movie/index.svelte-3066faf8.js", "chunks/vendor-069a40fc.js"];
    css9 = [];
  }
});

// .svelte-kit/output/server/entries/pages/movie/_id_.svelte.js
var id_svelte_exports2 = {};
__export(id_svelte_exports2, {
  default: () => U5Bidu5D2,
  load: () => load4
});
async function load4({ fetch: fetch2, params }) {
  const movieId = params.id;
  const res = await fetch2(`${"https://api.themoviedb.org/3"}/movie/${movieId}?api_key=${"22a2b619b5fe2221f6c9e2a24e7a28dd"}&language=en-US`);
  const data = await res.json();
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    init_id_svelte2();
    entry6 = "pages/movie/_id_.svelte-d85bc7bb.js";
    js6 = ["pages/movie/_id_.svelte-d85bc7bb.js", "chunks/vendor-069a40fc.js"];
    css11 = ["assets/pages/movie/_id_.svelte-734453ac.css"];
  }
});
...
function devalue(value) {
  ...
  Array.from(counts).filter(function(entry7) {
    ...
    return b[1] - a[1];
  }).forEach(function(entry7, i) {
    names.set(entry7[0], getName(i));
  });
